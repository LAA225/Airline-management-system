...
def correctTime(time):
	...
	or time[2] != ':' or int(hr) > 24 or int(m) > 60:
		return False
	else:
		return True
...
def editFlight(DB):
	...
	attr = input("which attribute to change(flight_id,departure_code,arrival_code,\
	departure_time, arrival_time, fare, airplane_model, date): ")
